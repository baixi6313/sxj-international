# -*- coding: utf-8 -*-
"""把 logo_clean/A_铜镜 的 10 个 mipmap 图标推送到 GitHub 仓库(Contents API)，触发 Actions 重编译。"""
...
SRC = r"C:\Users\Administrator\WorkBuddy\2026-07-24-23-26-27\logo_clean\A_铜镜"
...
def update(local, repo_path):
    ...
    st2, _ = api("PUT", "/" + repo_path,
                 {"message": "replace launcher icon with clean 铜镜 logo",
